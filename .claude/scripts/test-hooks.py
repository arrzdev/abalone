...
CASES: list[tuple[str, list[str]]] = [
    ...
    ("apps/game/src/data/auth/token.ts",
    ...
    ("apps/game/src/data/collections/items/mutations.ts",
     BASE + ["stack-sync-engine", "stack-frontend-data", "core-try-catch"]),
    ("apps/game/src/data/backend-client.ts",
     BASE + ["stack-frontend-data", "core-try-catch"]),
    # components/ui is both a component and shell — shell rules append
    ("apps/game/src/components/ui/drawer.tsx",
     BASE + ["core-react-components", "core-motion", "core-input-handling",
             "stack-ui-shell", "platform-ios-webkit", "stack-gotchas"]),
    ("apps/game/src/components/seat-bar.tsx",
     BASE + ["core-react-components", "core-motion", "core-input-handling"]),
    # the canvas renderer is a component AND a render surface — animation last
    ("apps/game/src/components/game-canvas.tsx",
     BASE + ["core-react-components", "core-motion", "core-input-handling",
             "core-animation-performance", "platform-ios-webkit"]),
    ("apps/game/src/render/draw-board.ts",
     BASE + ["core-animation-performance", "core-motion", "platform-ios-webkit"]),
    ("apps/game/src/data/sync/transport.ts",
     BASE + ["stack-sync-engine", "stack-frontend-data", "core-try-catch"]),
    ("packages/nativ/src/components/screen.tsx",
     BASE + ["stack-ui-shell", "core-react-components", "platform-ios-webkit", "stack-gotchas"]),
    ("apps/game/env/schema.ts",
