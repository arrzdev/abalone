---
name: core-planning
description: Phased approach for large or ambiguous work: discovery, explore, clarify, design options, build, review. Use when the task spans many files, requirements are unclear, or a real architecture choice is involved.
---
