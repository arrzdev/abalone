---
name: core-testing
description: What to test at which layer, the test pyramid, colocation rules, and the TDD loop. Use when adding tests, deciding what deserves a test, or writing a .test.ts file.
---
