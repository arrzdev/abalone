---
name: stack-turnstile
description: Cloudflare Turnstile end to end: the callback state machine, single-use tokens, the disabled-button UX rule, test keys for every branch, and the site-key/secret-key pairing invariant. Use when wiring or debugging the captcha. Not yet wired in this repo.
---
