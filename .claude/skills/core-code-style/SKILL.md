---
name: core-code-style
description: House code style: readable over clever, no abbreviations, named functions, guard clauses, comment format, immutability, TypeScript at boundaries, and avoiding deprecated APIs. Use before writing or reviewing any TypeScript or TSX.
---
...
**Read it before writing code, don't assume the defaults.** Line width in particular is a real authoring constraint: a narrow one changes how you break arguments and chains, and guessing 80/100 means the formatter rewrites everything you just wrote.
