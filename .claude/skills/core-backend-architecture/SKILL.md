...
description: Backend layering: services own one domain, facades orchestrate 2+ services, routes are the HTTP adapter. Covers constructor injection, who may call whom, facade extraction, and cross-service transactions. Use when writing a .service.ts or .facade.ts, adding business logic, or orchestrating multiple domains.
---
