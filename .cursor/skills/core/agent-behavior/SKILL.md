...
name: agent-behavior
description: >-
  Agent autonomy, when to ask, handoff, verification, TDD, scope boundaries when checks fail.
  Load for workflow, definition of done, or large ambiguous tasks with planning.
---
