...
description: >-
  Whether/how non-JS apps (Swift, Python, Go) can live in this pnpm+Turbo monorepo — the tooling boundary, language-agnostic APIs, CI + contract-codegen costs. Load for multi-tech, Swift/iOS, Python, polyglot, "can the monorepo host X" questions.
---
