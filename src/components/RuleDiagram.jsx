...
import { diagramAspect, drawDiagram } from '../render/drawDiagram.js';
...
export function RuleDiagram({ diagram, marbleDesign = 'default', label, className }) {
  ...
  const paint = useCallback(() => {
    ...
    if (width <= 0) return;
    const height = Math.round(Math.min(width / diagramAspect(diagram), MAX_HEIGHT));
