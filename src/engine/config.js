 ...
 *
 * Geometry lives in `topology.js` and timings in `render/timing.js`; what is
 * left here is the handful of constants that decide when a game is won and how
 * many marbles may travel together.
 */
