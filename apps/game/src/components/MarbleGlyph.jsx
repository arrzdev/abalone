...
import { renderMarble } from '../render/marbleRenderer.js';
import { cn } from '../lib/cn.js';

/** The two fills the board renderers understand. */
const MARBLE_FILL = { black: '#333', white: '#fff' };
 ...
 */
export function MarbleGlyph({ color, design = 'default', size = 12, className, title }) {
