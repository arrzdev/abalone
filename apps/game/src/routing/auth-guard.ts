...
//---- Route guard --------------------------------------------------
//whether a navigation has to be bounced to the sign-in screen.
//
...
/**
 * Whether this navigation must go to the sign-in screen instead.
 *
 ...
 * runs this again with the store it can actually see, and redirects only if
 * the device really is a guest.
 */
